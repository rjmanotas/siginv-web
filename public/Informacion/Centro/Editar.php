        ...
        <div class="row">
            <div class="col-md-4">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">ACTUALIZAR CENTRO</h5>
                        <form class="" action="<?php echo URL_SIGEMA;?>/Centro/Editar/<?php echo $datos['id']?>" method="POST">
                            <div class="row">
                                <div class="position-relative form-group col-md-12">
                                    <label class="" style="font-weight: bold;">NOMBRE DEL CENTRO:*</label>
                                    <input onkeyup="mayus(this);" class="form-control" name="CENTRO" value="<?php echo $datos['centro'];?>" placeholder="NOMBRE DEL CENTRO" type="text" required>
                                    </input>
                                    <label class="" style="font-weight: bold;">TELEFONO:*</label>
                                    <input onkeyup="mayus(this);" class="form-control" name="TELEFONO" value="<?php echo $datos['telefono'];?>" placeholder="Eje: 3122334444" type="text" required>
                                    </input>
                                    <label class="" style="font-weight: bold;">SUBDIRECTOR:*</label>
                                    <input onkeyup="mayus(this);" class="form-control" name="SUBDIRECTOR" value=" <?php echo $datos['subdirector']; ?>" placeholder="NOMBRE DEL SUBDIRECTOR" type="text" required>
                                    </input>
                                    ...
                                    <button class="mb-2 mr-2 btn btn-sigema-secundario col-md-12" type="submit" value="ACTUALIZAR">ACTUALIZAR</button>
                                </div>
                            </div>
                        </form>
                    </div>
