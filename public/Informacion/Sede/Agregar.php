            ...
            <div class="col-md-4">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form class="" method="POST" action="<?php echo URL_SIGEMA;?>/Sede/Crear">
                            <div class="row">
                                <div class="position-relative form-group col-md-12">
                                    <label class="" style="font-weight: bold;">NOMBRE DE LA SEDE:*</label>
                                    <input onkeyup="mayus(this);" class="form-control" name="SEDE" placeholder="NOMBRE DE LA SEDE" type="text"  required>
                                    </input>
                                    <label class="" style="font-weight: bold;">REGIONAL:*</label>
                                    <select class="mb-2 form-control" name="REGIONAL" id="CBX_REGIONAL" required="">
                                    ...
                                    <input onkeyup="mayus(this);" class="form-control" name="RESPONSABLE" placeholder="NOMBRE DEL RESPONSABLE" type="text" required>
                                    </input>
                                    <label class="" style="font-weight: bold;">TELEFONO:*</label>
                                    <input class="form-control" name="TELEFONO" placeholder="Eje: 3122334444" type="text" required>
                                    </input>
                                    <p class="text-muted"><i>Los campos con * son obligatorios</i></p>
                                    <button class="mb-2 mr-2 btn btn-sigema col-md-12" type="submit">REGISTRAR</button>
                                </div>
                            </div>
                        </form>
                    </div>
