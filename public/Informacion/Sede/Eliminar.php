            ...
            <div class="col-md-4">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">ELIMINAR SEDE</h5>
                        <form class="" method="POST" action="<?php echo URL_SIGEMA;?>/Sede/Eliminar/<?php echo $datos['id']?>">
                            <div class="row">
                                <div class="position-relative form-group col-md-12">
                                    <label class="" style="font-weight: bold;">NOMBRE DE LA SEDE:*</label>
                                    <input onkeyup="mayus(this);" class="form-control" name="SEDE" value="<?php echo $datos['sede']  ?>" type="text" disabled>
                                    </input>
                                    <label class="" style="font-weight: bold;">REGIONAL:*</label>
                                    <select class="mb-2 form-control" name="CBX_REGIONAL" id="CBX_REGIONAL" disabled > 
                                        
                                    </select>
                                    <label class="" style="font-weight: bold;">CENTRO:*</label>
                                    <select class="mb-2 form-control" name="CBX_CENTRO" id="CBX_CENTRO" disabled>
                                        
                                    </select>
                                    <label class="" style="font-weight: bold;">RESPONSABLE:*</label>
                                    <input onkeyup="mayus(this);" class="form-control" name="RESPONSABLE" value=" <?php echo $datos['responsable'] ?>" type="text" disabled>
                                    </input>
                                    <label class="" style="font-weight: bold;">TELEFONO:*</label>
                                    <input class="form-control" name="TELEFONO" value=" <?php echo $datos['telefono'] ?>" type="text" disabled>
                                    </input>
                                    <p class="text-muted"><i>Los campos con * son obligatorios</i></p>
                                    <button class="mb-2 mr-2 btn btn-eliminar col-md-12" type="submit">ELIMINAR</button>
                                </div>
                            </div>
                        </form>
                    </div>
