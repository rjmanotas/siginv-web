        ...
        <div class="row">
            <div class="col-md-4">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">ELIMINAR REGIONAL</h5>
                        <form class="" action="<?php echo URL_SIGEMA;?>/Regional/Delete/<?php echo $datos['id']?>" method="POST">
                            <div class="row">
                                <div class="position-relative form-group col-md-12">
                                    <label class="" style="font-weight: bold;">
                                        NOMBRE DE LA REGIONAL:*
                                    </label>
                                    <input class="form-control" name="REGIONAL" disabled="" value="<?php echo $datos['regional']; ?>" type="text">
                                    </input>
                                    <p class="text-muted"><i> Los campos con * son obligatorios</i></p>
                                    <button class="mb-2 mr-2 btn btn-eliminar col-md-12" type="submit" value="ELIMINAR">
                                        ELIMINAR
                                    </button>
                                </div>
                            </div>
