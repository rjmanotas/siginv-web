            ...
            <div class="col-md-4">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form class="" action="<?php echo URL_SIGEMA;?>/Regional/Crear" method="POST">
                            <div class="row">
                                <div class="position-relative form-group col-md-12">
                                    <label class="" style="font-weight: bold;">
                                        NOMBRE DE LA REGIONAL:*
                                    </label>
                                    <input onkeyup="mayus(this);" class="form-control" name="REGIONAL" placeholder="NOMBRE DE LA REGIONAL" type="text">
                                    </input>
                                    <p class="text-muted"><i> Los campos con * son obligatorios</i></p>
                                    <button class="mb-2 mr-2 btn btn-sigema col-md-12" type="submit" value="REGISTRAR">
                                        REGISTRAR
                                    </button>
                                </div>
                            </div>
            ...
            <div class="col-md-8">
                <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold">REGIONALES</h6>
                        </div>
                        <div class="card-body">
