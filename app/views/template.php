      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo URL_SISINV;?>Herramienta/ListarHerramienta">Consultar Herramientas</a>
            <a class="collapse-item" href="<?php echo URL_SISINV;?>Materiales/ListadoMateriales">Consultar Materiales</a>
            <a class="collapse-item" href="<?php echo URL_SISINV;?>Equipo/ListarEquipo">Consultar Equipos</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo URL_SISINV;?>Bodega/ListarBodega">Bodegas</a>
            <a class="collapse-item" href="<?php echo URL_SISINV;?>Estante/ListarEstante">Estantes</a>
            <a class="collapse-item" href="<?php echo URL_SISINV;?>Gaveta/ListarGaveta">Gavetas</a>
      ...
      <div id="content">
        ...
        <!--VALIDACION DEL MENU DINAMICO CON PRIVILEGIOS-->
                    <?php /* 
                        ...
                        }elseif ($_SESSION['sesion_active']['tipo_usuario'] == 'OBSERVADOR') {
                            require 'menus/Observador.php';
                        }elseif ($_SESSION['sesion_active']['tipo_usuario'] == 'SOLICITANTE') {
                            require 'menus/Solicitante.php';
                        }elseif ($_SESSION['sesion_active']['tipo_usuario'] == 'OPERARIO') {
                            require 'menus/Operario.php';
                        }
                   */ ?>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?php echo URL_SISINV;?>Login/Logout">Logout</a>
        </div>
      </div>
    </div>
  </div>
