            ...
            <div class="col-md-4">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form class="" action="<?php echo URL_SISINV;?>Bodega/EditarBodega/<?php echo $datos['idBodega'];?>" method="POST">
                            <div class="row">
                                <div class="position-relative form-group col-md-12">
                                    <label class="" style="font-weight: bold;">
                                        NOMBRE DE LA BODEGA:*
                                    </label>
                                    <input onkeyup="mayus(this);" class="form-control" name="NOM_BODEGA" value="<?php echo $datos['nombreBodega'];?>" type="text" required>
