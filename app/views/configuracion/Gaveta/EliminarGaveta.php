...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            <h1 class="h3 mb-2 text-gray-800">Eliminar Gavetas</h1>
            <p class="mb-4">
                        ...
                        <form class="" action="<?php echo URL_SISINV;?>Gaveta/EliminarGaveta/<?php echo $datos['idGaveta'];?>" method="POST">
                            <div class="row">
                                <div class="position-relative form-group col-md-12">
                                    ...
                                    <select class="form-control" name="NUM_ESTANTES" disabled>
                                        <option value=" <?php echo $datos['numEstante'];?>"><?php echo $datos['numEstante'];?></option>
                                    </select>
                                    <label class="" style="font-weight: bold;">
                                        NUMERO DE GAVETA:*
                                    </label>
                                    <input onkeyup="mayus(this);" value="<?php echo $datos['numGaveta'];?>" class="form-control" name="NUM_GAVETA"  placeholder="1-6" type="number" required disabled>
                                    <!-- <label class="" style="font-weight: bold;">
                                        DESCRIPCION:*
                                    </label>
